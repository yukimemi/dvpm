...
// File        : plugin.ts
// Author      : yukimemi
// Last Change : 2025/03/22 13:03:53.
// =============================================================================
...
import { exists, expandGlob } from "jsr:@std/fs@1.0.14";
...
export class Plugin {
  ...
  public static async create(
    ...
    p.info.clone = await p.is(p.info.clone == undefined ? p.info.enabled : p.info.clone);
